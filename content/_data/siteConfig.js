...
module.exports = {
  ...
  site: {
    ...
    description: 'Engineering thoughs',
    ...
    url: process.env.URL || 'https://blog.quadristan.fr',
  ...
  opengraph: {
    ...
    image: '/images/share-1200x600.png',
  ...
  twtxt: {
    ...
    avatar: '/images/share-400x400.png',
